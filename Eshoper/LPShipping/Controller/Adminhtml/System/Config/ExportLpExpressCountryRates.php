...
class ExportLpExpressCountryRates extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    /**
     * File response
     *
    ...
    {
        $fileName = 'lpexpress-country-rates.csv';

        /** @var $gridBlock \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPExpressCountryRates\Grid */
        $gridBlock = $this->_view->getLayout ()->createBlock (
            \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPExpressCountryRates\Grid::class
        );
