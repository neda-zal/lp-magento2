...
class ExportLpExpressCountryRatesWeight extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    /**
     * File response
     *
    ...
    {
        $fileName = 'lpexpress-country-rates-weight.csv';

        /** @var $gridBlock \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPExpressCountryRatesWeight\Grid */
        $gridBlock = $this->_view->getLayout ()->createBlock (
            \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPExpressCountryRatesWeight\Grid::class
        );
