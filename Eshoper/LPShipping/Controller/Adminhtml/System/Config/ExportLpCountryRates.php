...
class ExportLpCountryRates extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    /**
     * File response
     *
    ...
    {
        $fileName = 'lp-country-rates.csv';

        /** @var $gridBlock \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPCountryRates\Grid */
        $gridBlock = $this->_view->getLayout ()->createBlock (
            \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPCountryRates\Grid::class
        );
