...
class ExportLpExpressTableRates extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    /**
     * File response
     *
    ...
    {
        $fileName = 'lpexpress-tables.csv';

        /** @var $gridBlock \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPExpressTableRates\Grid */
        $gridBlock = $this->_view->getLayout ()->createBlock (
            \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPExpressTableRates\Grid::class
        );
