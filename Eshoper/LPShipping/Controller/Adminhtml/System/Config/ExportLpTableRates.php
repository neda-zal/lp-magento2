...
class ExportLpTableRates extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    /**
     * File response
     *
    ...
    public function execute()
    {
        ...
        /** @var $gridBlock \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPTableRates\Grid */
        $gridBlock = $this->_view->getLayout ()->createBlock (
            \Eshoper\LPShipping\Block\Adminhtml\Carrier\LPTableRates\Grid::class
        );
