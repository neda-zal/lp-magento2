...
class LPExpressCountryRates extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
     ...
     */
    protected $_LPExpressCountryRatesFactory;

    /**
     * Rates constructor.
     * @param \Magento\Framework\Filesystem $filesystem
     * @param \Magento\Framework\Model\ResourceModel\Db\Context $context
     * @param \Eshoper\LPShipping\Model\LPCountryRates $LPExpressCountryRatesFactory
     * @param null $connectionName
     */
    public function __construct (
        \Magento\Framework\Filesystem $filesystem,
        \Magento\Framework\Model\ResourceModel\Db\Context $context,
        \Eshoper\LPShipping\Model\LPExpressCountryRatesFactory $LPExpressCountryRatesFactory,
        $connectionName = null
    ) {
    ...
    public function uploadAndImport ( \Magento\Framework\DataObject $object )
    {
        ...
        if ( ! empty ( $data ) ) {
            ...
            foreach ( $data as $rate ) {
                ...
                $this->_LPExpressCountryRatesFactory->create ()
    ...
    {
        $rates     = $this->_LPExpressCountryRatesFactory->create ()->getCollection ()
