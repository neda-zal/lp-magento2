...
class LPCountryRatesWeight extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
     ...
     */
    protected $_LPCountryRatesWeightFactory;

    /**
     * Rates constructor.
     * @param \Magento\Framework\Filesystem $filesystem
     * @param \Magento\Framework\Model\ResourceModel\Db\Context $context
     * @param \Eshoper\LPShipping\Model\LPCountryRates $LPCountryRatesWeightFactory
     * @param null $connectionName
     */
    public function __construct (
        \Magento\Framework\Filesystem $filesystem,
        \Magento\Framework\Model\ResourceModel\Db\Context $context,
        \Eshoper\LPShipping\Model\LPCountryRatesWeightFactory $LPCountryRatesWeightFactory,
        $connectionName = null
    ) {
    ...
    {
        $this->_init ( 'lp_overseas_rates_weight', 'id' );
    }
    ...
    public function uploadAndImport ( \Magento\Framework\DataObject $object )
    {
        ...
        if ( ! empty ( $data ) ) {
            ...
            foreach ( $data as $rate ) {
                /** @var \Eshoper\LPShipping\Model\LPCountryRatesWeight $rates */
                $this->_LPCountryRatesWeightFactory->create ()
    ...
    {
        $weights   = [];
        $rates     = $this->_LPCountryRatesWeightFactory->create ()->getCollection ()
